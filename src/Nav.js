  ...
  return (
    <div 
      ...
      <ul class="nav nav-pills" style={{ justifyContent: 'space-around', fontSize: '16px'}} id='navbar'>
        <li class="nav-item">
              <NavLink to="/ReturnUser/Home" className="nav-link" style={{ display: 'flex',
        ...
        <li class="nav-item" >
            <NavLink to="/ReturnUser/Friends" className="nav-link" style={{ display: 'flex',
                              flexDirection: 'column',
                              justifyContent: 'center',
                              alignItems: 'center',
                              height: '50px'}}>
        ...
        <li class="nav-item" >
              <NavLink to="/ReturnUser/AccountPage" className="nav-link" style={{ display: 'flex',
